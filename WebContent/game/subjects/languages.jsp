...
<body>
	...
	<div class="container">
			...
			<header>
				...
				<h1>you got a <strong>Language</strong> question</h1>
				<h2><span>go for it</span></h2>
            	 </header>       
...
<div class="container1">
			...
			<section class="main clearfix">
				...
				<form action="../../MCQservlet" method="post">
					<input type="hidden" name="catagoryNumber" value="3"/>
					<div id="second">
						<div>
...
<%session.putValue("catagory","LANGUAGES"); %>
