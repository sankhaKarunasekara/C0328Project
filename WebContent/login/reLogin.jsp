...
<div class="container">
			...
			<div class="container">
					<a href="../wheelAfterCorrect.jsp" class="button"><span>✓</span>Solo game</a>
					<br><a href="../game/Chooser/playerChooser.jsp" class="button orange active"><span>✓</span>Start New Challenge</a>
					<br><a href="../gameRequests/onGoingGames.jsp" class="button purple"><span>✓</span><strong>Ongoing Games</strong></a>
					<br><a href="../stats/stats.jsp" class="button turquoise"><span>✓</span>View Your Status</a><br>
					<a href="../game/AddQuestion.html" class="button red"><span>✓</span>Add Question to DataBase</a>	
			</div>
		<div class="copyright">
